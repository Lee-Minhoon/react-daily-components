...
var Date = /** @class */ (function () {
    function Date(params) {
        ...
        this.year = (_a = params === null || params === void 0 ? void 0 : params.year) !== null && _a !== void 0 ? _a : DateTime.now().year;
        this.month = (_b = params === null || params === void 0 ? void 0 : params.month) !== null && _b !== void 0 ? _b : DateTime.now().month;
        this.day = (_c = params === null || params === void 0 ? void 0 : params.day) !== null && _c !== void 0 ? _c : DateTime.now().day;
        this.weekday = (_d = params === null || params === void 0 ? void 0 : params.weekday) !== null && _d !== void 0 ? _d : DateTime.now().weekday;
        this.weekNumber = (_e = params === null || params === void 0 ? void 0 : params.weekNumber) !== null && _e !== void 0 ? _e : DateTime.now().weekNumber;
    }
    ...
    Object.defineProperty(Date.prototype, "getYearString", {
        ...
        value: function (isTwoDigit) {
            return isTwoDigit
                ? "".concat(this.getYear() < 10 ? "0".concat(this.getYear()) : "".concat(this.getYear()))
                : "".concat(this.getYear());
        }
    });
...
export var getCalendarDate = function (dateTime) {
    var startDate = getNearestPrevMonday(dateTime.startOf("month"));
    var endDate = getNearestNextSunday(dateTime.endOf("month"));
    var calendarDate = [];
