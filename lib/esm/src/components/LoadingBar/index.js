...
var LoadingBar = function (_a) {
    ...
    return (_jsx(Style.Container, __assign({ backgroundColor: backgroundColor, isBlockedBackground: isBlockedBackground, isFullScreen: isFullScreen }, { children: _jsx(Style.Spinner, { spinnerSize: spinnerSize, spinnerBorderWidth: spinnerBorderWidth, spinnerBodyColor: spinnerBodyColor, spinnerBarColor: spinnerBarColor }) })));
};
