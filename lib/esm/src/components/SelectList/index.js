...
var SelectList = function (_a) {
    ...
    return (_jsxs(Style.SelectList, __assign({ ref: ref, isOpen: isOpen, maxItemCount: resultList.length > maxItemCount ? maxItemCount : resultList.length, width: width, height: height, borderRadius: borderRadius, outlineWidth: outlineWidth, outlineColor: outlineColor, style: isOpen ? selectListActiveStyle : selectListInactiveStyle }, { children: [_jsxs(Style.SelectWrapper, __assign({ isOpen: isOpen, height: height, borderRadius: borderRadius, outlineWidth: outlineWidth, outlineColor: outlineColor, style: isOpen ? selectWrapperActiveStyle : selectWrapperInactiveStyle }, { children: [searchable ? (_jsx(Style.Input, __assign({}, searchInput, { placeholder: placeholder, fontSize: fontSize, textColor: textColor, onKeyUp: function (e) { return handleKeyDown(e); } }))) : (_jsx(Style.Input, { value: value, placeholder: placeholder, readOnly: true, fontSize: fontSize, textColor: textColor })), _jsx(Style.Button, __assign({ onClick: handleOpenClick }, { children: _jsx(Style.Svg, __assign({ viewBox: "0 0 20 20", isOpen: isOpen, outlineColor: outlineColor, outlineWidth: outlineWidth }, { children: _jsx("polyline", { points: "2 6 10 14 18 6 10 14" }) })) }))] })), isOpen && (_jsx(Style.List, __assign({ maxItemCount: resultList.length > maxItemCount ? maxItemCount : resultList.length, height: height, fontSize: fontSize, textColor: textColor, borderRadius: borderRadius, outlineColor: outlineColor, style: isOpen ? listActiveStyle : listInactiveStyle }, { children: resultList.map(function (item, index) { return (_jsx(Style.Item, __assign({ onClick: function () { return handleSelectClick(item); }, height: height, borderRadius: borderRadius, style: isOpen ? itemActiveStyle : itemInactiveStyle }, { children: item }), index)); }) })))] })));
};
