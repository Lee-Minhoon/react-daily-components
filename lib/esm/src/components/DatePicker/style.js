...
export var ListContainer = styled.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  color: ", ";\n  margin-top: ", ";\n  text-align: center;\n  font-size: ", ";\n  position: absolute;\n  background-color: white;\n  z-index: 2;\n\n  &::after {\n    content: \"\";\n\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    top: 0;\n    left: 0;\n    border-radius: ", ";\n    outline: ", ";\n    opacity: 0.5;\n    box-shadow: ", ";\n  }\n"], ["\n  color: ", ";\n  margin-top: ", ";\n  text-align: center;\n  font-size: ", ";\n  position: absolute;\n  background-color: white;\n  z-index: 2;\n\n  &::after {\n    content: \"\";\n\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    top: 0;\n    left: 0;\n    border-radius: ", ";\n    outline: ", ";\n    opacity: 0.5;\n    box-shadow: ", ";\n  }\n"])), function (_a) {
    var textColor = _a.textColor;
    return textColor;
}, function (_a) {
...
export var YearMonth = styled.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  height: ", ";\n  font-size: ", ";\n  line-height: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  column-gap: 1em;\n"], ["\n  height: ", ";\n  font-size: ", ";\n  line-height: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  column-gap: 1em;\n"])), function (_a) {
    var height = _a.height;
    return "".concat(height, "px");
}, function (_a) {
    var fontSize = _a.fontSize;
...
export var WeekdayList = styled.ul(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  padding: 0;\n  margin: 0;\n  flex: 1;\n  display: grid;\n  grid-template-columns: repeat(7, 1fr);\n  list-style-type: none;\n"], ["\n  padding: 0;\n  margin: 0;\n  flex: 1;\n  display: grid;\n  grid-template-columns: repeat(7, 1fr);\n  list-style-type: none;\n"])));
export var WeekdayItem = styled.li(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  z-index: 1;\n  width: ", ";\n  height: ", ";\n  line-height: ", ";\n  font-size: ", ";\n"], ["\n  z-index: 1;\n  width: ", ";\n  height: ", ";\n  line-height: ", ";\n  font-size: ", ";\n"])), function (_a) {
    var width = _a.width;
    return "".concat(width, "px");
}, function (_a) {
    var height = _a.height;
...
export var List = styled.ul(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  padding: 0;\n  margin: 0;\n  flex: 1;\n  display: grid;\n  grid-template-columns: repeat(7, 1fr);\n  list-style-type: none;\n  overflow: hidden;\n  border-bottom-left-radius: ", ";\n  border-bottom-right-radius: ", ";\n"], ["\n  padding: 0;\n  margin: 0;\n  flex: 1;\n  display: grid;\n  grid-template-columns: repeat(7, 1fr);\n  list-style-type: none;\n  overflow: hidden;\n  border-bottom-left-radius: ", ";\n  border-bottom-right-radius: ", ";\n"])), function (_a) {
    var borderRadius = _a.borderRadius;
    return "".concat(borderRadius, "px");
}, function (_a) {
    var borderRadius = _a.borderRadius;
...
export var Item = styled.li(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  z-index: 1;\n  font-size: ", ";\n  height: ", ";\n  width: ", ";\n  line-height: ", ";\n  :hover {\n    cursor: pointer;\n    background-color: rgba(0, 0, 0, 0.1);\n    box-shadow: inset 0 0 4px rgba(0, 0, 0, 0.1);\n  }\n  background-color: ", ";\n  box-shadow: ", ";\n"], ["\n  z-index: 1;\n  font-size: ", ";\n  height: ", ";\n  width: ", ";\n  line-height: ", ";\n  :hover {\n    cursor: pointer;\n    background-color: rgba(0, 0, 0, 0.1);\n    box-shadow: inset 0 0 4px rgba(0, 0, 0, 0.1);\n  }\n  background-color: ", ";\n  box-shadow: ", ";\n"])), function (_a) {
    var _b = _a.fontSize, fontSize = _b === void 0 ? 16 : _b;
    return "".concat(fontSize * 0.75, "px");
}, function (_a) {
    var height = _a.height;
