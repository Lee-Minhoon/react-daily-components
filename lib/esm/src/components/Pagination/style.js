...
export var Container = styled.nav(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: ", ";\n  display: flex;\n  justify-content: center;\n  font-size: ", ";\n"], ["\n  width: ", ";\n  display: flex;\n  justify-content: center;\n  font-size: ", ";\n"])), function (_a) {
    var width = _a.width;
...
export var Item = styled.span(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: block;\n  width: 1em;\n  color: ", ";\n  font-weight: ", ";\n  opacity: ", ";\n  &:hover {\n    opacity: initial;\n  }\n"], ["\n  display: block;\n  width: 1em;\n  color: ", ";\n  font-weight: ", ";\n  opacity: ", ";\n  &:hover {\n    opacity: initial;\n  }\n"])), function (_a) {
    var color = _a.color;
    return color;
}, function (_a) {
    var activate = _a.activate;
...
export var PageItem = styled.li(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  &:hover {\n    cursor: ", ";\n  }\n"], ["\n  &:hover {\n    cursor: ", ";\n  }\n"])), function (_a) {
    var activate = _a.activate;
