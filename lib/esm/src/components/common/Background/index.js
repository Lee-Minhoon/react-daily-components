...
var Background = function (_a) {
    ...
    return (_jsx(Style.Background, __assign({ backgroundColor: backgroundColor, isBlockedBackground: isBlockedBackground, isFullScreen: isFullScreen }, { children: children })));
};
