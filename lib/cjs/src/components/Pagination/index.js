...
var Pagination = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Style.Container, __assign({ width: width, fontSize: fontSize, style: containerStyle }, { children: (0, jsx_runtime_1.jsx)(Style.List, __assign({ gap: gap }, { children: render() })) })));
};
