...
var TimePicker = function (_a) {
    ...
    var _p = (0, useModal_1.default)(), isOpen = _p.isOpen, setIsOpen = _p.setIsOpen, handleOpenClick = _p.handleOpenClick;
    ...
    var _s = (0, react_1.useState)(12), hour = _s[0], setHour = _s[1];
    var _t = (0, react_1.useState)(0), min = _t[0], setMin = _t[1];
    var _u = (0, react_1.useState)(0), seconds = _u[0], setSeconds = _u[1];
    var containerRef = (0, react_1.useRef)(null);
    var inputRef = (0, react_1.useRef)(null);
    var timeTypeRef = (0, react_1.useRef)(null);
    var hourRef = (0, react_1.useRef)(null);
    var minRef = (0, react_1.useRef)(null);
    var secondsRef = (0, react_1.useRef)(null);
    var _v = (0, useCursor_1.default)(inputRef, time), cursor = _v.cursor, setCursor = _v.setCursor;
    (0, useClickOutside_1.default)(containerRef, setIsOpen);
    (0, useSetScrollPosition_1.default)(hourRef, is24Hour ? hour * height : (hour % 12) * height, isOpen);
    (0, useSetScrollPosition_1.default)(minRef, min * height, isOpen);
    (0, useSetScrollPosition_1.default)(secondsRef, seconds * height, isOpen);
    ...
    return ((0, jsx_runtime_1.jsxs)(Style.Container, __assign({ ref: containerRef, isOpen: isOpen, maxItemCount: maxItemCount, width: width, height: height, borderRadius: borderRadius, outlineWidth: outlineWidth, outlineColor: outlineColor, style: isOpen ? selectListActiveStyle : selectListInactiveStyle }, { children: [(0, jsx_runtime_1.jsxs)(Style.SelectWrapper, __assign({ isOpen: isOpen, height: height, borderRadius: borderRadius, outlineWidth: outlineWidth, outlineColor: outlineColor, style: isOpen ? selectWrapperActiveStyle : selectWrapperInactiveStyle }, { children: [(0, jsx_runtime_1.jsx)(Style.Input, { ref: inputRef, value: !is24Hour
                            ...
                            : time.getString24Hour({
                                ...
                                isPrintMin: isSelectMin,
                                isPrintSeconds: isSelectSeconds,
                            }), fontSize: fontSize, textColor: textColor, onChange: function (e) { return handleChange(e); } }), (0, jsx_runtime_1.jsx)(ArrowButton_1.default, { handleOpenClick: handleOpenClick, isOpen: isOpen, outlineColor: outlineColor, outlineWidth: outlineWidth, direction: isOpen ? "Up" : "Down" })] })), isOpen && ((0, jsx_runtime_1.jsxs)(Style.ListContainer, __assign({ maxItemCount: maxItemCount, height: height, fontSize: fontSize, textColor: textColor, borderRadius: borderRadius, outlineWidth: outlineWidth, style: listContainerStyle }, { children: [!is24Hour && ((0, jsx_runtime_1.jsx)(TimeType_1.default, { timeTypeRef: timeTypeRef, timeType: timeType, setTimeType: setTimeType, height: height, listStyle: listStyle, itemStyle: itemStyle })), isSelectHour && ((0, jsx_runtime_1.jsx)(Hour_1.default, { hourRef: hourRef, hour: hour, setHour: setHour, is24Hour: is24Hour, height: height, listStyle: listStyle, itemStyle: itemStyle })), isSelectMin && ((0, jsx_runtime_1.jsx)(Min_1.default, { minRef: minRef, min: min, setMin: setMin, height: height, listStyle: listStyle, itemStyle: itemStyle })), isSelectSeconds && ((0, jsx_runtime_1.jsx)(Seconds_1.default, { secondsRef: secondsRef, seconds: seconds, setSeconds: setSeconds, height: height, listStyle: listStyle, itemStyle: itemStyle }))] })))] })));
};
