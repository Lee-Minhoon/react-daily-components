...
var TimePicker = function (_a) {
    ...
    (0, react_1.useEffect)(function () {
        if (timeTypeRef.current)
            timeTypeRef.current.scrollTop = timeType === time_1.TIME_TYPE.AM ? 0 : height;
        if (hourRef.current)
