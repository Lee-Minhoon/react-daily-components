...
exports.Item = exports.List = exports.Input = exports.SelectWrapper = exports.Container = void 0;
...
exports.List = styled_1.default.ul(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  list-style-type: none;\n  color: ", ";\n  padding: 0;\n  margin: 0;\n  margin-top: ", ";\n  max-height: ", ";\n  overflow-y: auto;\n  position: absolute;\n  background-color: white;\n  width: 100%;\n  font-size: ", ";\n  z-index: 2;\n  border-bottom-left-radius: ", ";\n  border-bottom-right-radius: ", ";\n  ::-webkit-scrollbar {\n    width: 12px;\n  }\n  ::-webkit-scrollbar-track {\n    background-color: whitesmoke;\n    border-radius: ", ";\n  }\n  ::-webkit-scrollbar-thumb {\n    background-color: rgba(0, 0, 0, 0.1);\n    border-radius: ", ";\n    box-shadow: inset 0 0 4px rgba(0, 0, 0, 0.1);\n  }\n"], ["\n  list-style-type: none;\n  color: ", ";\n  padding: 0;\n  margin: 0;\n  margin-top: ", ";\n  max-height: ", ";\n  overflow-y: auto;\n  position: absolute;\n  background-color: white;\n  width: 100%;\n  font-size: ", ";\n  z-index: 2;\n  border-bottom-left-radius: ", ";\n  border-bottom-right-radius: ", ";\n  ::-webkit-scrollbar {\n    width: 12px;\n  }\n  ::-webkit-scrollbar-track {\n    background-color: whitesmoke;\n    border-radius: ", ";\n  }\n  ::-webkit-scrollbar-thumb {\n    background-color: rgba(0, 0, 0, 0.1);\n    border-radius: ", ";\n    box-shadow: inset 0 0 4px rgba(0, 0, 0, 0.1);\n  }\n"])), function (_a) {
    var textColor = _a.textColor;
    return textColor;
}, function (_a) {
...
exports.Item = styled_1.default.li(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  height: ", ";\n  padding: 0 10px;\n  line-height: ", ";\n  overflow-x: hidden;\n  text-overflow: ellipsis;\n  :hover {\n    cursor: pointer;\n    background-color: rgba(0, 0, 0, 0.1);\n    box-shadow: inset 0 0 4px rgba(0, 0, 0, 0.1);\n  }\n  background-color: ", ";\n  box-shadow: ", ";\n"], ["\n  height: ", ";\n  padding: 0 10px;\n  line-height: ", ";\n  overflow-x: hidden;\n  text-overflow: ellipsis;\n  :hover {\n    cursor: pointer;\n    background-color: rgba(0, 0, 0, 0.1);\n    box-shadow: inset 0 0 4px rgba(0, 0, 0, 0.1);\n  }\n  background-color: ", ";\n  box-shadow: ", ";\n"])), function (_a) {
    var height = _a.height;
    return "".concat(height, "px");
}, function (_a) {
    var height = _a.height;
