...
exports.Button = exports.Input = exports.InputContainer = exports.Label = exports.Container = void 0;
var styled_1 = require("@emotion/styled");
var _1 = require(".");
var getFlexDirection = function (input) {
    return input === _1.LABEL_LOCATIONS.left || input === _1.LABEL_LOCATIONS.right
        ? "row"
        : "column";
};
var getAlignItems = function (input) {
    var centerCondition = input === _1.LABEL_LOCATIONS.left ||
        input === _1.LABEL_LOCATIONS.right ||
        input === _1.LABEL_LOCATIONS.topCenter ||
        input === _1.LABEL_LOCATIONS.botCenter;
    var rightCondition = input === _1.LABEL_LOCATIONS.topRight || input === _1.LABEL_LOCATIONS.botRight;
    if (centerCondition)
        return "center";
...
exports.Container = styled_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: ", ";\n  align-items: ", ";\n  width: ", ";\n  gap: ", ";\n"], ["\n  display: flex;\n  flex-direction: ", ";\n  align-items: ", ";\n  width: ", ";\n  gap: ", ";\n"])), function (_a) {
    var _b = _a.labelLocation, labelLocation = _b === void 0 ? _1.LABEL_LOCATIONS.left : _b;
...
exports.InputContainer = styled_1.default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  min-width: 0;\n  width: ", ";\n  height: ", ";\n  position: relative;\n  padding-inline-start: 10px;\n  display: flex;\n  align-items: center;\n  &::after {\n    content: \"\";\n    position: absolute;\n    z-index: -1;\n    width: 100%;\n    height: 100%;\n    top: 0;\n    left: 0;\n    outline: ", ";\n    border-radius: ", ";\n    opacity: ", ";\n    box-shadow: ", ";\n  }\n"], ["\n  min-width: 0;\n  width: ", ";\n  height: ", ";\n  position: relative;\n  padding-inline-start: 10px;\n  display: flex;\n  align-items: center;\n  &::after {\n    content: \"\";\n    position: absolute;\n    z-index: -1;\n    width: 100%;\n    height: 100%;\n    top: 0;\n    left: 0;\n    outline: ", ";\n    border-radius: ", ";\n    opacity: ", ";\n    box-shadow: ", ";\n  }\n"])), function (_a) {
    ...
    var isFocus = _a.isFocus;
    return isFocus ? "0 0 6px rgba(0, 0, 0, 0.4)" : "initial";
});
...
exports.Button = styled_1.default.button(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  color: ", ";\n  font-size: ", ";\n  height: 100%;\n  border: none;\n  background-color: initial;\n  padding: 0 10px;\n  cursor: pointer;\n  position: relative;\n  &::after {\n    content: \"\";\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    top: 0;\n    left: 0;\n    border-left: ", ";\n    opacity: ", ";\n  }\n"], ["\n  color: ", ";\n  font-size: ", ";\n  height: 100%;\n  border: none;\n  background-color: initial;\n  padding: 0 10px;\n  cursor: pointer;\n  position: relative;\n  &::after {\n    content: \"\";\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    top: 0;\n    left: 0;\n    border-left: ", ";\n    opacity: ", ";\n  }\n"])), function (_a) {
    var textColor = _a.textColor;
    return textColor;
}, function (_a) {
    var fontSize = _a.fontSize;
